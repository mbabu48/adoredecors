...
const galleryItems = [
  {
    ...
    title: "Rose & Ivory Wedding Ceremony",
    description: "Classic ceremony setup with blush roses, ivory drapes, and gold accent columns.",
    eventType: "wedding",
    featured: true,
    displayOrder: 1,
  },
  ...
  },
  {
    ...
    title: "Floral Welcome Table",
    description: "Sunflower and dahlia welcome display with a floral arch and countryside backdrop.",
    eventType: "wedding",
    featured: false,
    displayOrder: 8,
  },
...
const feedbackItems = [
  {
    ...
    rating: 5,
    message:
      "Adore Decors transformed our reception hall into something from a dream. Every petal placed with intention, every drape perfectly pleated. Guests are still talking about it.",
    approved: true,
    featured: true,
  },
  {
...
const inquiryItems = [
  {
    ...
    guestCount: 250,
    venueSize: "large",
    message: "Traditional church wedding, looking for a floral ceremony arch, aisle decor, and a reception stage.",
    estimatedCost: 5500,
    status: "new",
    source: "contact",
  },
...
const orderItems = [
  {
    ...
    eventType: "corporate",
    eventDate: new Date("2026-05-05"),
    venueAddress: "The Langham Hotel, Chicago, IL",
    guestCount: 150,
    totalAmount: 4500,
    advancePaid: 2250,
    status: "confirmed",
  ...
  },
  {
    ...
    customerEmail: "ashley.m@example.com",
    customerPhone: "+1 (555) 345-6789",
    eventType: "baby_shower",
    eventDate: new Date("2026-05-02"),
    venueAddress: "Beverly Hills, CA",
    guestCount: 40,
    totalAmount: 1000,
    advancePaid: 500,
    status: "in_progress",
