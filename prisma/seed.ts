...
const galleryItems = [
  {
    ...
    title: "Rose & Ivory Wedding Arch",
    description: "Classic ceremony arch with blush roses, ivory drapes, and gold accent columns.",
    eventType: "wedding",
    featured: true,
    displayOrder: 1,
  },
  ...
  },
  {
    ...
    title: "Floral Ceremony Setup",
    description: "Vibrant yellow floral ceremony with a paisley-print backdrop and low garden seating.",
    eventType: "wedding",
    featured: false,
    displayOrder: 8,
  },
...
const feedbackItems = [
  {
    ...
    rating: 5,
    message:
      "The team turned our wedding venue into something from a dream. Every petal placed with intention, every drape perfectly pleated. Guests are still talking about it.",
    approved: true,
    featured: true,
  },
  {
...
const inquiryItems = [
  {
    ...
    guestCount: 250,
    venueSize: "large",
    message: "Traditional wedding ceremony, looking for a floral arch and a reception stage.",
    estimatedCost: 2500,
    status: "new",
    source: "contact",
  },
...
const orderItems = [
  {
    ...
    customerPhone: "+1 (555) 412-3456",
    eventType: "corporate",
    eventDate: new Date("2026-05-05"),
    venueAddress: "The Beverly Hilton, Beverly Hills, CA",
    guestCount: 150,
    totalAmount: 1700,
    advancePaid: 850,
    status: "confirmed",
  ...
  },
  {
    ...
    customerPhone: "+1 (555) 998-7665",
    eventType: "baby_shower",
    eventDate: new Date("2026-05-02"),
    venueAddress: "Sherman Oaks, Los Angeles, CA",
    guestCount: 40,
    totalAmount: 500,
    advancePaid: 250,
    status: "in_progress",
